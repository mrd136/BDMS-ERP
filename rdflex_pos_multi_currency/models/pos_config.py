...
class PosOrder(models.Model):
    ...
    def _order_fields(self, ui_order):
        ...
        res['order_currency_id'] = ui_order.get('currency').get('id')
        return res

    def _prepare_invoice(self):
        res = super(PosOrder, self)._prepare_invoice()
        res['currency_id'] = self.order_currency_id.id or self.pricelist_id.currency_id.id
        return res
